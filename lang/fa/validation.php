...
return [
    ...
    */
    ...
    'enum' => ':attribute انتخاب شده صحیح نمی باشد',

    'mac_address' => ':attribute باید یک آدرس مک معتبر باشد',
    'password' => [
        ...
        'symbols' => ':attribute باید حداقل یک نماد یا سیمبول داشته باشد',
        'uncompromised' => ':attribute با الگوهای تعیین شده سازش ناپذیر است لطفا برای :attribute مقدار دیگری انتخاب کنید',
    ],
    'required_array_keys' => ':attribute باید حاوی ورودی هایی مانند :values',
    'doesnt_start_with' => ':attribute نباید حاوی ورودی هایی مانند :values',
